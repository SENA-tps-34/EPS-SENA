...
CREATE TABLE `tratamientos` (
  ...
  CONSTRAINT `tratamientos_ibfk_1` FOREIGN KEY (`TraPaciente`) REFERENCES `pacientes` (`PacIdentificasion`)
...
INSERT INTO `tratamientos` VALUES (3,'2023-05-05','Tratamiento para dolor de cabeza','2023-05-06','2023-05-10','Tomar una pastilla cada 8 horas',987654321);
