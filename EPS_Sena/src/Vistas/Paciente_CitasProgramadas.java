...
public class Paciente_CitasProgramadas extends javax.swing.JFrame {

   
    public Paciente_CitasProgramadas() {
        initComponents();
...
// icono JFrame 
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/UserBlanco.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Paciente_CitasProgramadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
