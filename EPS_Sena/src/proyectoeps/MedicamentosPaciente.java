...
public class MedicamentosPaciente extends javax.swing.JFrame {

    public MedicamentosPaciente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MedicamentosPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
